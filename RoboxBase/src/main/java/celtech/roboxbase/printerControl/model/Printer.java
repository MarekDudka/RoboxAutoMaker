...
public interface Printer extends RoboxResponseConsumer
{
    ...
    /**
     * Mark the fitted reels as needing their EEPROM re-read on the next status
     * poll, so that locally cached data (e.g. remaining filament) is refreshed
     * from the printer. Used after a print completes, since the firmware
     * updates the reel's remaining filament during printing.
     */
    public void requestReelEEPROMRefresh();
